<template>
    <div class="m-icons-fav">
        <div class="m-title"><i class="el-icon-star-on u-icon"></i> {{ $t('收藏图标') }}</div>
        <el-alert class="m-icons-tips" v-if="!favList.length" :title="$t('没有收藏的图标，请搜索图标进行添加。')" type="info" center show-icon :closable="false"></el-alert>
