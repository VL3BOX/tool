<template>
    <div class="m-icons-view">
        <el-input :placeholder="$t('输入搜索条件，按 enter 进行搜索')" v-model="search" class="input-with-select" clearable @keyup.enter.native="onSearch" @clear="onClear">
